...
function Home() {
  ...
  return (
    <div className="home">
      <h4
        className="text-dark text-center jersey-25-regular"
        style={{
          fontSize: 35,
        }}
      >
      ...
      >
        <div
          ...
          style={{
            ...
            height: 300,
            backgroundImage:
              'url("https://th.bing.com/th/id/OIP.Woe9qWNemw8tk1kUPCYJYwHaEA?w=317&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7")',
      ...
      <Row className="View">
        {Data.map((item) => (
          <Col sm={8} md={4} lg={3} className="CARD" style={{
            background:'white'
          }} onClick={() => {
